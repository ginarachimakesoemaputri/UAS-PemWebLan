...
<head>
    ...
    <title>Register &mdash; Animalia PetShop</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/modules/bootstrap-social/bootstrap-social.css">
...
<body>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form id="formAuthentication" class="mb-3 needs-validation"
                                    action="<?php echo base_url(); ?>public/register/check" method="POST" novalidate="">
                        ...
                        <div class="mt-5 text-muted text-center">
                            Already have an account? <a href="<?php echo base_url("public/login"); ?>">Login instead</a>
                        </div>
    ...
    <!-- General JS Scripts -->
    <script src="<?php echo base_url(); ?>/public/assets/modules/jquery.min.js"></script>
